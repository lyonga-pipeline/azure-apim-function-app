...
# Entra diagnostics are tenant-level Microsoft.AADIAM settings. The HCP run
# identity must have tenant-level permission at /providers/Microsoft.aadiam,
# such as Contributor, in addition to normal subscription RBAC.
