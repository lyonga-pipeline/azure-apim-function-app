variable "name" {
  description = "Name of the Application Gateway. Changing this forces a new resource."
  type        = string
}
...
variable "firewall_policy_id" {
  description = "ID of an externally managed WAF policy to associate."
  type        = string
  default     = null
}
variable "force_firewall_policy_association" {
  description = "Force association of the WAF policy even if the SKU tier is not WAF_v2."
  type        = bool
  default     = false
}
variable "http2_enabled" {
  description = "Enable HTTP/2 on the gateway."
  type        = bool
  default     = true
}
variable "sku" {
