...
output "resource_group_name" {
  ...
  value       = azurerm_storage_account.account.resource_group_name
}
...
output "primary_location" {
  ...
  value       = azurerm_storage_account.account.primary_location
}

output "secondary_location" {
  description = "The secondary storage location when geo-replication is enabled."
  value       = azurerm_storage_account.account.secondary_location
}

output "identity_principal_id" {
  description = "The system-assigned managed identity principal ID, when enabled."
  value       = try(azurerm_storage_account.account.identity[0].principal_id, null)
}

output "identity_tenant_id" {
  description = "The managed identity tenant ID, when enabled."
  value       = try(azurerm_storage_account.account.identity[0].tenant_id, null)
}
...
output "primary_table_endpoint" {
  ...
  value       = azurerm_storage_account.account.primary_table_endpoint
}

output "primary_file_endpoint" {
  description = "The primary File endpoint."
  value       = azurerm_storage_account.account.primary_file_endpoint
}

output "primary_dfs_endpoint" {
  description = "The primary DFS endpoint."
  value       = azurerm_storage_account.account.primary_dfs_endpoint
}
...
output "primary_endpoints" {
  ...
  value = {
    blob  = azurerm_storage_account.account.primary_blob_endpoint
    queue = azurerm_storage_account.account.primary_queue_endpoint
    table = azurerm_storage_account.account.primary_table_endpoint
    file  = azurerm_storage_account.account.primary_file_endpoint
    dfs   = azurerm_storage_account.account.primary_dfs_endpoint
    web   = azurerm_storage_account.account.primary_web_endpoint
  }
}
...
output "primary_hosts" {
  ...
  value = {
    blob  = azurerm_storage_account.account.primary_blob_host
    queue = azurerm_storage_account.account.primary_queue_host
    table = azurerm_storage_account.account.primary_table_host
    file  = azurerm_storage_account.account.primary_file_host
    dfs   = azurerm_storage_account.account.primary_dfs_host
    web   = azurerm_storage_account.account.primary_web_host
  }
}
