# terraform-azurerm-compeer-monitor-data-collection-rule

A single azurerm_monitor_data_collection_rule. `destinations` and `data_flows` are typed; data-source blocks (perf counters, syslog, extensions) are optional typed objects.
