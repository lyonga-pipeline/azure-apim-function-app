# ExpressRoute Circuit Module

This module manages ExpressRoute circuits and related hybrid connectivity configuration.
...
Module-specific extension points: Circuit, peering, authorization, and provider attributes remain input-driven so hybrid connectivity roots can model different carrier and routing designs.
