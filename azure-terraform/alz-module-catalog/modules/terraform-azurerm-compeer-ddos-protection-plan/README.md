...
This module manages an Azure DDoS Protection Plan for network patterns that attach protected virtual networks.
...
Module-specific extension points: DDoS plan creation is independent from virtual networks so hub, spoke, and shared-services patterns can attach plans only where needed.
