...
output "resource_group_name" {
  ...
  value       = azurerm_private_dns_resolver.resolver.resource_group_name
}
output "location" {
  description = "Azure region of the private DNS resolver."
  value       = azurerm_private_dns_resolver.resolver.location
}
output "virtual_network_id" {
  description = "Resource ID of the virtual network the resolver is bound to."
  value       = azurerm_private_dns_resolver.resolver.virtual_network_id
}
output "inbound_endpoint_ids" {
  description = "Map of caller-supplied key to inbound endpoint resource ID."
  value       = { for key, value in azurerm_private_dns_resolver_inbound_endpoint.inbound_endpoint : key => value.id }
}
output "inbound_endpoints" {
  ...
  value = {
    for key, value in azurerm_private_dns_resolver_inbound_endpoint.inbound_endpoint : key => {
      id                = value.id
      name              = value.name
...
output "outbound_endpoint_ids" {
  ...
  value       = { for key, value in azurerm_private_dns_resolver_outbound_endpoint.outbound_endpoint : key => value.id }
}
output "outbound_endpoints" {
  description = "Map of caller-supplied key to outbound endpoint attributes (id, subnet_id)."
  value = {
    for key, value in azurerm_private_dns_resolver_outbound_endpoint.outbound_endpoint : key => {
      id        = value.id
      name      = value.name
...
output "forwarding_ruleset_ids" {
  ...
  value       = { for key, value in azurerm_private_dns_resolver_dns_forwarding_ruleset.ruleset : key => value.id }
}
output "forwarding_rule_ids" {
  description = "Map of caller-supplied key to DNS forwarding rule resource ID."
  value       = { for key, value in azurerm_private_dns_resolver_forwarding_rule.forwarding_rule : key => value.id }
}
output "forwarding_ruleset_vnet_link_ids" {
  ...
  value       = { for key, value in azurerm_private_dns_resolver_virtual_network_link.vnet_link : key => value.id }
}
