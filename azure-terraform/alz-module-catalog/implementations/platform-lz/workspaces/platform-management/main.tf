...
module "management" {
  ...
  # Resource names come from the naming module inside the pattern - it is the
  # 'management' component. Only region + environment are supplied here; add a
  # `name` to a block in terraform.tfvars to override one.
  naming = {
    region             = var.location
