...
palo_alto = {
  ...
  notes                 = "Palo Alto VM-Series/Panorama lifecycle is governed externally until the approved vendor design is ready; this root enforces the hub route and subnet contract only."
  bootstrap = {
    enabled              = false
    storage_account_name = null
    container_name       = null
    config_repository    = null
  }
  management = {
    platform  = "panorama-or-strata"
    reference = null
  }
}
...
dns_resolution = {
  ...
  notes                    = "MVP uses DC-hosted DNS over ExpressRoute. Set mode to private-resolver and enable resolver modules after NET-27 is approved."
}
...
# Optional Palo Alto-facing platform resources. Keep these empty for the
# cost-safe baseline; populate only after the firewall HA/egress design is
# approved.
public_ips     = {}
load_balancers = {}

# Example public egress IP for a future approved Palo Alto untrust design:
#
# public_ips = {
#   palo_egress_01 = {
#     name              = "pip-palo-egress-np-001"
...
# }
#
# Example internal trust load balancer for a future approved HA design:
#
# load_balancers = {
#   palo_trust = {
#     name = "lb-palo-trust-np"
#     frontend_ip_configurations = {
#       trust = {
#         subnet_key                    = "palo_alto_trust"
#         private_ip_address            = "10.40.4.70"
...
#         backend_address_pool_names     = ["firewalls"]
#         probe_name                     = "ha"
