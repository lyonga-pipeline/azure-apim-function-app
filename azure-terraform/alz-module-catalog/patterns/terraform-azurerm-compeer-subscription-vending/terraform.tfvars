...
management_groups = {
  ...
  # Phase 2 dormant regulated-apps tree. Keep the management groups visible in
  # the target hierarchy, but do not vend subscriptions until regulated workload
  ...
  # Phase 2 dormant shared-services tree. Use this for enterprise shared service
  # subscriptions after ownership and lifecycle controls are approved.
  "shared-services-mg" = {
...
# Optional subscription bootstrap RBAC. Keep empty until client Entra group or
# managed identity object IDs are approved. Prefer group-based assignments with
# PIM for privileged roles; avoid direct user assignments.
subscription_role_assignments = {
  # "platform-management-sub-owner" = {
  #   subscription_key      = "platform-management-sub"
  #   principal_id          = "<entra-group-object-id>"
  #   principal_type        = "Group"
  #   role_definition_name  = "Owner"
  #   description           = "Subscription owners for approved platform management operations."
  # }
  # "platform-management-sub-reader" = {
  #   subscription_key      = "platform-management-sub"
  #   principal_id          = "<entra-group-object-id>"
  #   principal_type        = "Group"
  #   role_definition_name  = "Reader"
  #   description           = "Read-only access for platform audit and operations."
  # }
}
