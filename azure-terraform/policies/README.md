...
This directory contains the policy foundation for the net-new landing-zone path.
...
| Azure Policy | Runtime guardrails at management-group or subscription scope | Audit for pilot, then Deny for selected net-new scopes |
