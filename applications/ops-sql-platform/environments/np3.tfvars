...
private_dns_zones = {
  sql = {
    ...
    resource_group_name = "opssql-np3-dns-rg"
  }
  internal = {
    name                = "ops.internal"
    resource_group_name = "opssql-np3-dns-rg"
...
private_dns_links = {
  sql = {
    name                  = "opssql-np3-sql-link"
    resource_group_name   = "opssql-np3-dns-rg"
    private_dns_zone_name = "privatelink.database.windows.net"
  }
  internal = {
    name                  = "opssql-np3-internal-link"
    resource_group_name   = "opssql-np3-dns-rg"
...
sql_private_endpoint = {
  ...
  private_service_connection = {
    name              = "opssql-np3-sql-psc"
    subresource_names = ["sqlServer"]
  }
  private_dns_zone_group = {
    private_dns_zone_ids = ["/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/opssql-np3-dns-rg/providers/Microsoft.Network/privateDnsZones/privatelink.database.windows.net"]
  }
}
