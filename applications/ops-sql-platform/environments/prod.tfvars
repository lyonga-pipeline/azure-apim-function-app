...
private_dns_zones = {
  sql = {
    ...
    resource_group_name = "opssql-prod-dns-rg"
  }
  internal = {
    name                = "ops.internal"
    resource_group_name = "opssql-prod-dns-rg"
...
private_dns_links = {
  sql = {
    name                  = "opssql-prod-sql-link"
    resource_group_name   = "opssql-prod-dns-rg"
    private_dns_zone_name = "privatelink.database.windows.net"
  }
  internal = {
    name                  = "opssql-prod-internal-link"
    resource_group_name   = "opssql-prod-dns-rg"
...
sql_private_endpoint = {
  ...
  private_service_connection = {
    name              = "opssql-prod-sql-psc"
    subresource_names = ["sqlServer"]
  }
  private_dns_zone_group = {
    private_dns_zone_ids = ["/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/opssql-prod-dns-rg/providers/Microsoft.Network/privateDnsZones/privatelink.database.windows.net"]
  }
}
