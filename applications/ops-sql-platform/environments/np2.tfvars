...
private_dns_zones = {
  sql = {
    ...
    resource_group_name = "opssql-np2-dns-rg"
  }
  internal = {
    name                = "ops.internal"
    resource_group_name = "opssql-np2-dns-rg"
...
private_dns_links = {
  sql = {
    name                  = "opssql-np2-sql-link"
    resource_group_name   = "opssql-np2-dns-rg"
    private_dns_zone_name = "privatelink.database.windows.net"
  }
  internal = {
    name                  = "opssql-np2-internal-link"
    resource_group_name   = "opssql-np2-dns-rg"
...
sql_private_endpoint = {
  ...
  private_service_connection = {
    name              = "opssql-np2-sql-psc"
    subresource_names = ["sqlServer"]
  }
  private_dns_zone_group = {
    private_dns_zone_ids = ["/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/opssql-np2-dns-rg/providers/Microsoft.Network/privateDnsZones/privatelink.database.windows.net"]
  }
}
