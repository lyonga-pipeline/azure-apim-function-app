...
private_dns_zones = {
  web = {
    ...
    resource_group_name = "integration-np2-dns-rg"
  }
  kv = {
...
private_dns_links = {
  web = {
    name                  = "integration-np2-web-link"
    resource_group_name   = "integration-np2-dns-rg"
    private_dns_zone_name = "privatelink.azurewebsites.net"
  }
  kv = {
    name                  = "integration-np2-kv-link"
    resource_group_name   = "integration-np2-dns-rg"
...
function_app_private_endpoint = {
  ...
  private_service_connection = {
    name              = "integration-np2-func-psc"
    subresource_names = ["sites"]
  }
  private_dns_zone_group = {
    private_dns_zone_ids = ["/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/integration-np2-dns-rg/providers/Microsoft.Network/privateDnsZones/privatelink.azurewebsites.net"]
  }
}
...
key_vault_private_endpoint = {
  subnet_name = "private-endpoints"
  private_service_connection = {
    name              = "integration-np2-kv-psc"
    subresource_names = ["vault"]
  }
  private_dns_zone_group = {
    private_dns_zone_ids = ["/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/integration-np2-dns-rg/providers/Microsoft.Network/privateDnsZones/privatelink.vaultcore.azure.net"]
  }
}
