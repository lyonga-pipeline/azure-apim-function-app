...
private_dns_zones = {
  internal = {
    ...
    resource_group_name = "apianalytics-np3-dns-rg"
  }
}

private_dns_links = {
  internal = {
    name                  = "apianalytics-np3-internal-link"
    resource_group_name   = "apianalytics-np3-dns-rg"
...
key_vault_certificates = {
  gateway = {
    issuer_name        = "Self"
    subject            = "CN=api.np3.contoso.internal"
    validity_in_months = 12
    subject_alternative_names = {
      dns_names = ["api.np3.contoso.internal"]
    }
  }
}
...
application_gateway = {
  ...
  backend_address_pools = {
    apim = {
      fqdns = ["api.np3.contoso.internal"]
    }
  }
  probes = {
    apim = {
  ...
  backend_http_settings = {
    apim = {
      ...
      request_timeout = 30
      probe_name      = "apim"
      host_name       = "api.np3.contoso.internal"
    }
  }
  http_listeners = {
    public = {
...
apim_service = {
  ...
  identity = {
    type         = "UserAssigned"
    identity_ids = ["/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/apianalytics-np3-identity-rg/providers/Microsoft.ManagedIdentity/userAssignedIdentities/apim-np3-mi"]
  }
...
apim_backend = {
  protocol = "http"
  url      = "https://backend.np3.contoso.internal"
  title    = "np3-backend"
  credentials = {
    header = {
...
apim_api = {
  ...
  path                  = "orders"
  protocols             = ["https"]
  service_url           = "https://backend.np3.contoso.internal/orders"
...
apim_api_policy = {
  ...
  <policies>
    <inbound>
      <base />
      <set-backend-service backend-id="apianalytics-np3-backend" />
    </inbound>
    <backend>
      <base />
    </backend>
