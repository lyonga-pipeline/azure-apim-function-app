...
private_dns_zones = {
  internal = {
    ...
    resource_group_name = "apianalytics-prod-dns-rg"
  }
}

private_dns_links = {
  internal = {
    name                  = "apianalytics-prod-internal-link"
    resource_group_name   = "apianalytics-prod-dns-rg"
...
key_vault_certificates = {
  gateway = {
    issuer_name        = "Self"
    subject            = "CN=api.prod.contoso.internal"
    validity_in_months = 12
    subject_alternative_names = {
      dns_names = ["api.prod.contoso.internal"]
    }
  }
}
...
application_gateway = {
  ...
  backend_address_pools = {
    apim = {
      fqdns = ["api.prod.contoso.internal"]
    }
  }
  probes = {
    apim = {
      ...
      host     = "api.prod.contoso.internal"
    }
  }
  backend_http_settings = {
    apim = {
      ...
      request_timeout = 30
      probe_name      = "apim"
      host_name       = "api.prod.contoso.internal"
    }
  }
  http_listeners = {
    public = {
...
apim_service = {
  ...
  identity = {
    type         = "UserAssigned"
    identity_ids = ["/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/apianalytics-prod-identity-rg/providers/Microsoft.ManagedIdentity/userAssignedIdentities/apim-prod-mi"]
  }
...
apim_backend = {
  protocol = "http"
  url      = "https://backend.prod.contoso.internal"
  title    = "prod-backend"
  credentials = {
    header = {
...
apim_api = {
  ...
  path                  = "orders"
  protocols             = ["https"]
  service_url           = "https://backend.prod.contoso.internal/orders"
...
apim_api_policy = {
  ...
  <policies>
    <inbound>
      <base />
      <set-backend-service backend-id="apianalytics-prod-backend" />
    </inbound>
    <backend>
      <base />
    </backend>
